...
HTTPS_GIT := github.com/rollchains/corechain.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=corechain \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c corechain --local -f chains.yaml
endif
